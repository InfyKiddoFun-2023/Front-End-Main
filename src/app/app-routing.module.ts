...
const routes: Routes = [
  ...
  // { path: 'reports', component: MainLayoutComponent, canActivate: [AuthGuard], data: {animation: 'Home'}, loadChildren: () => import('./features/reports/reports.module').then(m => m.ReportsModule) },
